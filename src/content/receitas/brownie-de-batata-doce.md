...
ingredientes:
  ...
  - "2 ovos"
  - "3 colheres de sopa de mel ou tâmaras trituradas"
...
> ⚠️ **Erro comum:** Usar uma forma grande demais. Em uma forma de 30 x 20 cm, o brownie ficará com menos de 1 cm de espessura e vai assar rápido demais, ficando seco. Use uma forma menor para obter brownies com espessura de 2 a 3 cm.
...
> ⚠️ **Erro comum:** Adicionar os ovos diretamente na batata quente sem misturar constantemente. O calor coagula a clara de ovo instantaneamente. Certifique-se de que a batata está morna (não quente) antes de adicionar os ovos.
...
> ⚠️ **Erro comum:** Assar até o palito sair seco. Um brownie com palito seco é um brownie ressecado. O objetivo é o ponto fudgy (úmido e denso no centro), não o ponto cake (seco e esponjoso).
...
|-------------|-----------|----------------------|
| Batata doce laranja | Abóbora cabotiá cozida | Menos doce, mais neutra, igualmente úmida |
| Mel | Tâmaras trituradas | Mais fibra, índice glicêmico menor, sabor caramelado |
| Pasta de amendoim | Pasta de castanha de caju | Sabor mais suave e sofisticado |
| Ovos | 2 "ovos de linhaça" (1 col. linhaça + 3 col. água) | Versão vegana, textura levemente mais densa |
| Cacau 100% | Alfarroba em pó | Naturalmente mais doce, sem cafeína, sabor diferente |
| Extrato de baunilha | Pasta de baunilha | Sabor mais intenso, pontos de baunilha visíveis |

---

## Como Armazenar

**Geladeira:** Até 6 dias em pote hermético ou coberto com filme plástico. A textura melhora com o tempo.
**Freezer:** Sim, até 3 meses. Congele os quadradinhos individualmente em papel-manteiga, depois em saco fechado. Descongele na geladeira overnight.
**Temperatura ambiente:** Até 2 dias em local fresco e seco, coberto. Não recomendado em dias quentes pois o brownie pode fermentar.
