...
ingredientes:
  ...
  - "1 maçã pequena"
  - "10 uvas"
  - "10g de castanha-do-pará (2 unidades)"
  - "15g de nozes picadas"
  - "10g de amêndoas"
instrucoes:
  - "Lave as frutas em água corrente."
  - "Corte a maçã em fatias e a banana em rodelas."
  - "Disponha as frutas em uma tigela ou pote com tampa."
  - "Adicione as castanhas, nozes e amêndoas por cima."
  - "Consuma 30 a 45 minutos antes do treino para energia sustentada."
keywords:
  - "frutas pré-treino"
  - "castanhas fitness"
  - "lanche natural"
...
**Freezer:** Não recomendado para frutas frescas.

A textura após descongelar é muito mole para este lanche. As castanhas podem ser congeladas por até 1 ano sem perda significativa de qualidade.
...
Este mix de frutas e castanhas oferece uma combinação de três tipos de carboidratos que funcionam em janelas temporais diferentes: a banana e as uvas fornecem glicose e frutose de absorção rápida (energia em 15-20 minutos), a maçã tem carboidratos moderados com fibras que moderam a absorção (energia em 30-40 minutos), e as frutas em geral contêm frutose que é prioritariamente usada pelo fígado para repor glicogênio hepático.

Importante para atividades de resistência.
...
Exatamente o que o pré-treino precisa.
